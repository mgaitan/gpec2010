...
de generación gráficos. Se resume en el siguiente diagrama de secuencia:
...
simultánea de múltiples pestañas. 
...
su ascendencia de clases en el siguiente diagrama:
...
los gráficos a través de los algoritmos 
`Anti-Grain Geometry <http://www.antigrain.com>`_ que aplican técnicas
como *Anti-Aliasing* [#]_ o *Precisión de subpixel* para mejorar la definición
