...
El siguiente programa aplica conceptos de programación orientada  a objetos 
...
de código equivalente en otros lenguajes de programación.
    ...
    ... seealso::
        ...
        ampliar los conceptos aquí vertidos puede ver [TUT-PSF] y [MP2001].
...
de objetos (en particular listas y tuplas), son muy eficientes pero
están diseñados para ser multipropósito. Estos "contenedores" pueden tener cualquier
...
especialmente concebidas para tal fin. 
    ...
    .. note:: 
        ...
        de paráfrasis y traducido por el autor, de [NUMPY-UG]_.

`Numpy <http://numpy.org>`_ es una biblioteca que extiende Python para suplir 
este aspecto, proveyendo un tipo de objeto vector multidimensional y varios objetos derivados (como vectores enmascarados o matrices), 
además de rutinas optimizadas para la operación sobre estos vectores, incluyendo 
operaciones matemáticas y lógicas, manipulación de las dimensiones, álgebra lineal, 
...
pueden contener millones de números, se pagará el precio de la iteración ineficiente. 
...
código C). La vectorización tiene muchas ventajas:
    ...
    * El código se parece más a la notación matemática estándar (por lo que es más fácil, 
      por lo general, el código correctamente construcciones matemáticas
...
.. [TP-PSF]  van Rossum, Guido (2010), *The Python Tutorial v2.7*, Python Software Foundation, 
...
.. [NUMPY-UG] Scipy community, *Numpy User Guide*,  
